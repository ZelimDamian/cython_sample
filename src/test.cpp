...
static PyTypeObject *__pyx_ptype_4test_MyTest = 0;
...
static int __pyx_pw_4test_6MyTest_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__init__ (wrapper)", 0);
  {
    ...
    __pyx_v_num = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_num == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("__init__", 1, 1, 1, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 10, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("test.MyTest.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return -1;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4test_6MyTest___init__(((struct __pyx_obj_4test_MyTest *)__pyx_v_self), __pyx_v_num);
...
/* Python wrapper */
static PyObject *__pyx_pw_4test_6MyTest_3test(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_4test_6MyTest_3test(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("test (wrapper)", 0);
  __pyx_r = __pyx_pf_4test_6MyTest_2test(((struct __pyx_obj_4test_MyTest *)__pyx_v_self));
...
static PyObject *__pyx_tp_new_4test_MyTest(PyTypeObject *t, CYTHON_UNUSED PyObject *a, CYTHON_UNUSED PyObject *k) {
  struct __pyx_obj_4test_MyTest *p;
  PyObject *o;
  ...
  p = ((struct __pyx_obj_4test_MyTest *)o);
  new((void*)&(p->c_test)) bv::Test();
  return o;
}

static void __pyx_tp_dealloc_4test_MyTest(PyObject *o) {
  struct __pyx_obj_4test_MyTest *p = (struct __pyx_obj_4test_MyTest *)o;
  #if PY_VERSION_HEX >= 0x030400a1
  if (unlikely(Py_TYPE(o)->tp_finalize) && (!PyType_IS_GC(Py_TYPE(o)) || !_PyGC_FINALIZED(o))) {
    if (PyObject_CallFinalizerFromDealloc(o)) return;
  }
  #endif
  __Pyx_call_destructor(p->c_test);
  (*Py_TYPE(o)->tp_free)(o);
}

static PyMethodDef __pyx_methods_4test_MyTest[] = {
  {"test", (PyCFunction)__pyx_pw_4test_6MyTest_3test, METH_NOARGS, 0},
  {0, 0, 0, 0}
};

static PyTypeObject __pyx_type_4test_MyTest = {
  PyVarObject_HEAD_INIT(0, 0)
  "test.MyTest", /*tp_name*/
  sizeof(struct __pyx_obj_4test_MyTest), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_4test_MyTest, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  0, /*tp_setattr*/
  #if PY_MAJOR_VERSION < 3
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_4test_MyTest, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_descr_set*/
  0, /*tp_dictoffset*/
  __pyx_pw_4test_6MyTest_1__init__, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_4test_MyTest, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
#endif
{
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_4test_MyTest) < 0) __PYX_ERR(0, 7, __pyx_L1_error)
  __pyx_type_4test_MyTest.tp_print = 0;
  if (PyObject_SetAttrString(__pyx_m, "MyTest", (PyObject *)&__pyx_type_4test_MyTest) < 0) __PYX_ERR(0, 7, __pyx_L1_error)
  __pyx_ptype_4test_MyTest = &__pyx_type_4test_MyTest;
  /*--- Type import code ---*/
